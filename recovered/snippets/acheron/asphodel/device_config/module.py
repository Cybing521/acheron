...
# File: tmp7v2uhe33.marshal (Python 3.11)
...
def convert_unit_type(unit_type = None):
...
def convert_setting(setting = None, nvm = None):
...
def convert_ctrl_var(name = None, ctrl_var = None, value = None):
    return {
        'name': name,
...
def configure_setting(setting = None, value = None, device_info = None, nvm = ('setting', asphodel.AsphodelSettingInfo, 'value', Any, 'device_info', DeviceInfo, 'nvm', bytearray, 'return', None)):
...
def configure_nvm(device_config = None, device_info = None, nvm = None):
