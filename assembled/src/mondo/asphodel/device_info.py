...
class DeviceInfo:
    ...
    def from_apd_header(header):
        # TODO: pycdc could not reconstruct this body.
        # Signature was recovered from the code object; default values may need manual repair.
        # Bytecode excerpt:
        #    0 MAKE_CELL field_names
        #    2 RESUME
        #    4 LOAD_CONST <code object <setcomp> at 0x105af9b50, file "asphodel\device_info.py", line 104>
        #    6 MAKE_FUNCTION
        #    8 LOAD_GLOBAL NULL + fields
        #   20 LOAD_GLOBAL DeviceInfo
        #   32 PRECALL
        #   36 CALL
        #   46 GET_ITER
        #   48 PRECALL
        #   52 CALL
        #   62 STORE_DEREF field_names
        #   64 LOAD_CLOSURE field_names
        #   66 BUILD_TUPLE
        #   68 LOAD_CONST <code object <dictcomp> at 0x105af89d0, file "asphodel\device_info.py", line 105>
        #   70 MAKE_FUNCTION closure
        #   72 LOAD_FAST header
        ...
        #  112 PRECALL
        #  116 CALL
        #  126 STORE_FAST filtered_dict
        #  128 LOAD_GLOBAL NULL + DeviceInfo
        #  140 LOAD_CONST ()
        #  142 BUILD_MAP
        #  144 LOAD_FAST filtered_dict
        #  146 DICT_MERGE
        #  148 CALL_FUNCTION_EX
        #  150 RETURN_VALUE
        pass
...
def single_call(key_name, func_name, optional):
    ...
    #  118 BUILD_TUPLE
    #  120 LOAD_CONST <code object func at 0x105aed450, file "asphodel\device_info.py", line 159>
...
def array_call(key, device_info, incrementer, count_fn, element_fn, count_key, element_cost, skippable):
    ...
    #  168 LOAD_CONST <code object <genexpr> at 0x105af8b90, file "asphodel\device_info.py", line 197>
    #  170 MAKE_FUNCTION
    #  172 LOAD_FAST array
    #  174 GET_ITER
    #  176 PRECALL
...
def get_custom_enums(device, device_info, incrementer):
    ...
    #   48 LOAD_CONST <code object <genexpr> at 0x105af9450, file "asphodel\device_info.py", line 222>
    #   50 MAKE_FUNCTION
    #   52 LOAD_DEREF d
    ...
    #  134 LOAD_CLOSURE d
    #  136 BUILD_TUPLE
    #  138 LOAD_CONST <code object <genexpr> at 0x105ab7e30, file "asphodel\device_info.py", line 224>
    ...
    #  348 LOAD_CONST <code object <dictcomp> at 0x105af9ed0, file "asphodel\device_info.py", line 233>
    #  350 MAKE_FUNCTION
...
def get_setting_categories(device, device_info, incrementer):
    ...
    #  102 BUILD_TUPLE
    #  104 LOAD_CONST <code object element_fn at 0x105a72c10, file "asphodel\device_info.py", line 246>
...
def get_channel_calibrations(device, device_info, incrementer):
    ...
    #   80 BUILD_TUPLE
    #   82 LOAD_CONST <code object element_fn at 0x100acf470, file "asphodel\device_info.py", line 294>
...
def get_supplies(device, device_info, incrementer):
    ...
    #   86 BUILD_TUPLE
    #   88 LOAD_CONST <code object element_fn at 0x105a73870, file "asphodel\device_info.py", line 315>
...
def get_supply_results(device, device_info, incrementer):
    ...
    #   98 BUILD_TUPLE
    #  100 LOAD_CONST <code object element_fn at 0x105a73750, file "asphodel\device_info.py", line 328>
...
def get_ctrl_vars(device, device_info, incrementer):
    ...
    #   88 BUILD_TUPLE
    #   90 LOAD_CONST <code object element_fn at 0x105a732d0, file "asphodel\device_info.py", line 342>
...
def get_nvm(device, device_info, incrementer):
    ...
    #  418 BUILD_TUPLE
    #  420 LOAD_CONST <code object read_user_tag_string at 0x105acc810, file "asphodel\device_info.py", line 393>
...
def hash_is_valid(h):
    ...
    #   62 LOAD_CONST <code object <genexpr> at 0x105afa170, file "asphodel\device_info.py", line 549>
    #   64 MAKE_FUNCTION
    ...
    #  116 LOAD_CONST <code object <genexpr> at 0x105af98b0, file "asphodel\device_info.py", line 551>
    #  118 MAKE_FUNCTION
